(function (global, factory) {
  ...
  var getFieldsValues = (fieldsRef, unmountFieldsStateRef, search) => {
      const output = {};
      const fields = Object.assign(Object.assign({}, fieldsRef.current), (unmountFieldsStateRef && unmountFieldsStateRef.current));
  ...
  function useForm({ mode = VALIDATION_MODE.onSubmit, reValidateMode = VALIDATION_MODE.onChange, resolver, context, defaultValues = {}, shouldFocusError = true, shouldUnregister = true, criteriaMode, } = {}) {
      ...
      const { current: { isOnBlur, isOnSubmit, isOnChange, isOnAll }, } = React.useRef(modeChecker(mode));
